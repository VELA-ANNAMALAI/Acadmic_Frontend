...
const UpdatePage = () => {
  ...
  const facultyName = state?.facultyName; // Use optional chaining to avoid errors
  const staffId = state?.staffId;
 console.log(facultyName,staffId)
    ...
    try {
      ...
      if (response.data) {
        ...
        setTimeout(() => {
          ...
          navigate(`/updatestudent?staffId=${staffId}&facultyName=${encodeURIComponent(facultyName)}`);
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      navigate(`/updatestudent?staffId=${staffId}&facultyName=${encodeURIComponent(facultyName)}`); // Redirect after deletion
    } catch (err) {
  ...
  return (
    ...
    <Col xs={2} className="sidebar">
        <FacultySidebar 
            ...
            staffId={staffId} // Ensure this is defined
        ...
        <div className="card mt-4 shadow">
          ...
          <div className="card-body  ">
            ...
            <div className="justify-center text-center">
              {student.photo ? (
                <img src={student.photo} alt="Student" style={{ width: '100px', height: '100px' }} />
              ) : (
                <div style={{ width: '100px', height: '100px', border: '1px dashed #ccc', margin: '0 auto' }}>
                  No Photo Available
                </div>
              )}
            ...
            <Col md={4}>
              ...
              <Row>
                ...
                <Col md={4}>
                  <Form.Group className="mb-3">
                    <Form.Label>Dayscholar/Hostel:</Form.Label>
                    <Form.Control
                      type="text"
              ...
              <Row>
                ...
                <Col md={4}>
                  <Form.Group className="mb-3">
                    <Form.Label>Parent Phone No:</Form.Label>
                    <Form.Control
                      type="text"
                      name="parentPhone"
