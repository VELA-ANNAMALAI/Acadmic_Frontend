...
const AddStudent = () => {
  ...
  const fetchFacultyNames = async () => {
    try {
      const response = await axios.get(`https://academic-backend-5azj.onrender.com/addstudents/facultyname`);
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...facultyData,
      dob: facultyData.dob || " ", // Set to null if empty
    };
        ...
        <Row>
          <Col lg={6} className="mb-4">
            ...
            <Form.Group controlId="Religion">
              ...
              <Form.Control as="select" name="Religion" value={studentData.Religion} onChange={handleChange} required>
