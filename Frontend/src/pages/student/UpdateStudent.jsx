...
const UpdateStudent = () => {
  ...
  console.log(staffId,facultyName)
  ...
  const handleUpdate = (stu) => {
    navigate(`/update-student/${stu.registerno}`, { 
      state: { 
        student: stu,
        facultyName: facultyName, // Include facultyName
                  ...
                  <tbody>
                    {student.map((stu) => (
                      <tr key={stu._id}>
                        ...
                        <td>
                        <Link 
                          to={`/update-student/${stu.registerno}`} 
                          className="btn btn-primary" 
                          state={{ 
                            facultyName: facultyName, // Pass facultyName
