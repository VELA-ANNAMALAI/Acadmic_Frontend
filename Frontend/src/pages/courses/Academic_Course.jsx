...
import FacultySidebar from '../SIDEBAR/facultysidebar.jsx'; // Adjust the import path as necessary
import { useNavigate } from 'react-router-dom';

export default function Academic_Course() {
  ...
  const [newCourse, setNewCourse] = useState({ academicYear: '', subjects: {}, courseName: '', semesters: [] });
  ...
  // Fetch degrees and departments on component mount
  useEffect(() => {
    fetchDegrees();
  }, []);
